...
VALUES
('Уборка парка', 'Генеральная уборка Центрального городского парка', '2025-05-15', 'Центральный парк', 20, 'park_cleanup.jpg', 3),
('Помощь приюту для животных', 'Кормление животных и уборка вольеров', '2025-08-02', 'Приют "Добрые руки"', 15, 'animal_shelter.jpg', 3),
('Благотворительный забег', 'Ежегодный забег в поддержку детских домов', '2025-04-21', 'Городской стадион', 50, 'charity_run.jpg', 3),
('Обучение пожилых людей', 'Базовый курс компьютерной грамотности', '2025-07-30', 'Библиотека №5', 10, 'seniors_course.jpg', 3),
('Экологическая акция', 'Сбор пластика и макулатуры в микрорайоне', '2025-06-24', 'Сквер у фонтана', 30, 'eco_action.jpg', 3);
